...
collection = chroma_client.get_collection(name="readthedocs_openai", embedding_function=openai_ef)

results=collection.query(query_texts=["email notifications"], n_results=3)
